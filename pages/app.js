// pages/app.js - ChatLedger Application
"use client";
...
import MessengerChatInterface from "../components/Chat/MessengerChatInterface";
...
/* ====================== PAGE ====================== */
export default function ChatLedgerApp() {
  ...
  /* ===================== APP ===================== */
  const renderContent = (activeTab, selectedFriend, handleStartChat) => {
    switch (activeTab) {
      case "dashboard":
        return <Dashboard />;
      case "chat":
        return <MessengerChatInterface selectedFriend={selectedFriend} />;
      case "friends":
        return <FriendsList onStartChat={handleStartChat} hideSection={true} />;
      case "transfers":
